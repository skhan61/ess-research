...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=10cm,keepaspectratio]{../../outputs/H1/C_C_fold1/predictions/predictions.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{../../outputs/H2/L_L_fold1/predictions/predictions.png}
        \caption{Fold 1 --- Dice 0.568}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{../../outputs/H2/L_L_fold2/predictions/predictions.png}
        \caption{Fold 2 --- Dice 0.442}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth]{../../outputs/H2/L_L_fold3/predictions/predictions.png}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{../../outputs/H3/C_C_fold1/predictions/predictions.png}
        \caption{C$\to$C fold1 --- Dice \textbf{0.9329}}
    \end{subfigure}
    \begin{subfigure}[b]{0.48\linewidth}
        \includegraphics[width=\linewidth]{../../outputs/H3/L_L_fold1/predictions/predictions.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth,height=5.5cm,keepaspectratio]{../../outputs/H4/C_C_fold1_prompt_modebox/predictions/predictions.png}
        \caption{C$\to$C box --- 0.9476}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth,height=5.5cm,keepaspectratio]{../../outputs/H4/C_C_fold1_prompt_modepoint/predictions/predictions.png}
        \caption{C$\to$C point --- 0.9281}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth,height=5.5cm,keepaspectratio]{../../outputs/H4/C_C_fold1_prompt_modeall/predictions/predictions.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth,height=5.5cm,keepaspectratio]{../../outputs/H4/L_L_fold1_prompt_modebox/predictions/predictions.png}
        \caption{L$\to$L fold1 box --- 0.9593}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth,height=5.5cm,keepaspectratio]{../../outputs/H4/L_L_fold1_prompt_modepoint/predictions/predictions.png}
        \caption{L$\to$L fold1 point --- 0.9132}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=\linewidth,height=5.5cm,keepaspectratio]{../../outputs/H4/L_L_fold1_prompt_modeall/predictions/predictions.png}
...
% OUTPUT:       outputs/H5/analysis/dice_distributions.png
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=9cm,keepaspectratio]{../../outputs/H5/analysis/dice_distributions.png}
...
% GENERATED BY: uv run python scripts/h5_failure_analysis.py
% OUTPUT:       outputs/H5/analysis/worst_frames_grid.png
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth,height=8cm,keepaspectratio]{../../outputs/H5/analysis/worst_frames_grid.png}
...
\begin{enumerate}[noitemsep, label={[\arabic*]}]
    \item F.~Qin et al., ``Towards Better Surgical Instrument Segmentation.''
          \textit{IEEE RA-L}, 2020.
          \href{https://arxiv.org/abs/2002.10675}{arxiv:2002.10675}
    \item ``HFRF-Net: Dual-task hierarchical feature refinement and fusion.''
          \textit{Expert Systems with Applications}, 2025. [Dice $=0.9374$]
    \item N.~Ravi et al., ``SAM~2: Segment Anything in Images and Videos.'' 2024.
          \href{https://arxiv.org/abs/2408.00714}{arxiv:2408.00714}
    \item C.~da Costa Rocha et al., ``Self-Supervised Surgical Tool Segmentation
          using Kinematic Information.'' \textit{ICRA}, 2019.
          \href{https://arxiv.org/abs/1902.04810}{arxiv:1902.04810}
    \item L.~Sestini et al., ``SAF-IS: Spatial Annotation Free Framework for
          Surgical Tool Segmentation.'' \textit{Medical Image Analysis}, 2025.
          \href{https://arxiv.org/abs/2309.01723}{arxiv:2309.01723}
    \item W.~Yue et al., ``SurgicalSAM: Efficient Class Promptable Segmentation.''
          \textit{AAAI}, 2024.
          \href{https://arxiv.org/abs/2308.08746}{arxiv:2308.08746}
    \item Z.~Wu et al., ``Point Tracking and SAM for Surgical Instrument Segmentation.''
          2024. \href{https://arxiv.org/abs/2403.08003}{arxiv:2403.08003}
    \item H.~Liu et al., ``Surgical SAM~2: Real-time Segmentation via Frame Pruning.''
          2024. \href{https://arxiv.org/abs/2408.07931}{arxiv:2408.07931}
\end{enumerate}
